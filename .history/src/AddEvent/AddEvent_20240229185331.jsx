    ...
    <>
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          try {
            SendData(newData, data, UserId); //update user's events in firebase. Data is array of data, newData is data to be added
...
async function SendData(newData, data, UserId) {
  /*
